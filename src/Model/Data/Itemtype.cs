...
public partial class Itemtype
{
    ...
    public string? MaxSockets1 { get; set; }

    public long? MaxSocketsLevelThreshold1 { get; set; }

    public string? MaxSockets2 { get; set; }

    public long? MaxSocketsLevelThreshold2 { get; set; }

    public string? MaxSockets3 { get; set; }
