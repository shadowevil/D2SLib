...
public partial class Skilldesc
{
    public string? Skilldesc1 { get; set; }

    public long? SkillPage { get; set; }

    public long? SkillRow { get; set; }

    public long? SkillColumn { get; set; }

    public long? ListRow { get; set; }
    ...
    public long? Desccalcb1 { get; set; }

    public long? Descline2 { get; set; }
    ...
    public string? Dsc2calcb5 { get; set; }

    public long? Dsc3line1 { get; set; }
