...
public partial class Gem
{
    ...
    public long? WeaponMod1Min { get; set; }

    public long? WeaponMod1Max { get; set; }
    ...
    public long? HelmMod1Min { get; set; }

    public long? HelmMod1Max { get; set; }
    ...
    public long? ShieldMod1Min { get; set; }

    public long? ShieldMod1Max { get; set; }
